...
function loader(source) {
  ...
  if (script || scriptSetup) {
    const lang =
      (script === null || script === void 0 ? void 0 : script.lang) ||
      (scriptSetup === null || scriptSetup === void 0
        ? void 0
        : scriptSetup.lang)
    ...
    if (enableInlineMatchResource) {
      scriptRequest = stringifyRequest(
        (0, util_1.genMatchResource)(this, src, query, lang || 'js')
      )
    } else {
  ...
  const useInlineTemplate = (0, resolveScript_1.canInlineTemplate)(
    descriptor,
    isProduction
  )
      ...
      .forEach((style, i) => {
        ...
        if (enableInlineMatchResource) {
          styleRequest = stringifyRequest(
            (0, util_1.genMatchResource)(this, src, query, lang)
          )
        } else {
        ...
        if (style.module) {
          ...
          stylesCode += (0, cssModules_1.genCSSModulesCode)(
            id,
            i,
            styleRequest,
            style.module,
  ...
  if (!isProduction || options.exposeFullFilePath) {
        ...
        .map((block, i) => {
          ...
          if (enableInlineMatchResource) {
            customRequest = stringifyRequest(
              (0, util_1.genMatchResource)(this, src, query, block.attrs.lang)
            )
          } else {
