...
exports.testWebpack5 =
  exports.genMatchResource =
  exports.stringifyRequest =
  exports.getOptions =
  exports.resolveTemplateTSOptions =
  exports.needHMR =
    void 0
...
function needHMR(vueLoaderOptions, compilerOptions) {
  var _a
  const isServer =
    (_a = vueLoaderOptions.isServerBuild) !== null && _a !== void 0
      ? _a
      : compilerOptions.target === 'node'
  const isProduction =
...
function resolveTemplateTSOptions(descriptor, options) {
  ...
  const lang =
    ...
    ((_b = descriptor.scriptSetup) === null || _b === void 0 ? void 0 : _b.lang)
  const isTS = !!(lang && /tsx?$/.test(lang))
  let expressionPlugins =
    ((_c =
      options === null || options === void 0
        ? void 0
        : options.compilerOptions) === null || _c === void 0
      ? void 0
      : _c.expressionPlugins) || []
...
const testWebpack5 = (compiler) => {
  ...
  const webpackVersion =
    (_a =
      compiler === null || compiler === void 0 ? void 0 : compiler.webpack) ===
      null || _a === void 0
      ? void 0
      : _a.version
