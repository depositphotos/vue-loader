...
const pitch = function () {
  ...
  if (query.type === `style`) {
    if (
      isWebpack5 &&
      ((_a = context._compiler) === null || _a === void 0
        ? void 0
        : _a.options.experiments.css)
    ) {
      ...
      const loaderString = [stylePostLoaderPath, ...loaders]
        ...
        .join('!')
      const styleRequest = (0, util_1.stringifyRequest)(
        context,
...
function genRequest(loaders, lang, context) {
  ...
  if (enableInlineMatchResource) {
    return (0, util_1.stringifyRequest)(
      context,
