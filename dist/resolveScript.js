...
exports.resolveScript =
  exports.canInlineTemplate =
  exports.typeDepToSFCMap =
  exports.clientCache =
    void 0
...
function resolveScript(descriptor, scopeId, options, loaderContext) {
    ...
    resolved = compileScript(descriptor, {
      ...
      templateOptions: {
        ...
        compilerOptions: Object.assign(
          ...
          (0, util_1.resolveTemplateTSOptions)(descriptor, options)
        ),
  ...
  if (
    !isProd &&
    (resolved === null || resolved === void 0 ? void 0 : resolved.deps)
  ) {
